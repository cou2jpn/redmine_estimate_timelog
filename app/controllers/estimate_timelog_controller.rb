...
class EstimateTimelogController < ApplicationController
  ...
  def report
    ...
    TimeEntryCustomField.select {|cf| %w(list bool).include? cf.field_format }.each do |cf|
    ...
    TimeEntryActivityCustomField.select {|cf| %w(list bool).include? cf.field_format }.each do |cf|
